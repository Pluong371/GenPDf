import type { ListBalanceSheet,ListIncomeStatement, ListIndirectMethod,IndustryDataModel, TopCompanyByNetRevenueModel, Branches, Subsidiaries, Affiliates } from "../models/pdf.model";
 ...
 */
export function flattenAndProcess<T, R>(arr: any[], processor: (item: T) => R): R[] {
  // Kiểm tra đầu vào
...
export function processTopCompanyByNetRevenue(item: TopCompanyByNetRevenueModel): any {
    const handleNullValue = (value: any) => {
        return value === null || value === undefined ? "N/A" : value;
      };
